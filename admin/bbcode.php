...
class bbcode
{
	...
	function bbcode_form($type = 'add')
	{
		...
		$forums->admin->print_cells_row(array("<strong>" . $forums->lang['bbcodereplacement'] . "</strong><div class='description'>&lt;tag&gt;{content}&lt;/tag&gt;<br />&lt;tag='{option}'&gt;{content}&lt;/tag&gt;</div>", $forums->admin->print_textarea_row('bbcodereplacement', input::get('bbcodereplacement', utf8::htmlspecialchars($bbcode['bbcodereplacement'])))));
